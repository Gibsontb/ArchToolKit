...
import { description, listOf, netmask, parseCidrDual, vlanIds, vlanRange, wildcard,                   } from '../device.js';
...
export const IOS_EXTRA_2                             = [
  ...
  deviceBlueprint({
    ...
    change: (values                 )               => {
      ...
      const findings            = [...invalidEntries('network.ios.bad-groups', 'Groups this RP serves', groupList.invalid)];
  ...
  deviceBlueprint({
    ...
    change: (values                 )               => {
      ...
      const v6Prefix = (id        , label        , fallback        ) => {
  ...
  deviceBlueprint({
    ...
    change: (values                 )               => {
      ...
      const v6 = !!source6;
      const findings            = [...invalidEntries('network.ios.bad-source', 'Match source', sources.invalid), ...invalidEntries('network.ios.bad-destination', 'Match destination', destinations.invalid)];
  ...
  deviceBlueprint({
    ...
    change: (values                 )               => {
      ...
      const classMap = (name        ) => (v6 ? [`class-map match-any ${name}`, ` match access-group name ${name}`, ` match access-group name ${name}${V6}`] : [`class-map match-all ${name}`, ` match access-group name ${name}`]);
