...
import { listOf, netmask, parseCidrDual, wildcard } from '../device.js';
...
export function addressList(text        )                                                  {
  const out = { v4: []            , v6: []            , other: []             };
  for (const item of listOf(text)) {
 ...
 */
export function interfaceAddressLines(v4                     , v6                    )           {
...
export function routerIdFindings(value        , what = 'The router id')            {
...
export function noIpv6(code        , feature        , remediation         )          {
...
export function invalidEntries(code        , what        , invalid                   )            {
