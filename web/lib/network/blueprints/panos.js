  ...
  deviceBlueprint({
    ...
    change: (values                 )               => {
      ...
      return {
        ...
        verify: [`show object address-group ${group}`, 'show config diff', 'commit force description "ArchToolKit: address objects"'],
        ...
        push: {
          ...
          after: [
            ...
            },
            {
              ...
              args: { provider: PROVIDER, description: 'ArchToolKit: address objects' },
            },
          ],
        },
        findings,
    ...
    change: (values                 )               => {
      ...
      return {
        ...
        config: [
          ...
          `${prefix} security rules ${name} description "Generated by ArchToolKit"`,
        ],
        verify: ['show config diff', `test security-policy-match from ${str(values, 'source_zone', '')} to ${str(values, 'dest_zone', '')} source 10.0.0.1 destination 10.0.0.2 protocol 6 destination-port 443`, 'commit description "ArchToolKit: security rule"'],
        ...
        push: {
          ...
          after: [
            { name: 'Commit the candidate configuration', module: 'paloaltonetworks.panos.panos_commit_firewall', args: { provider: PROVIDER, description: 'ArchToolKit: security rule' } },
          ],
        },
        findings,
      };
  ...
  deviceBlueprint({
    ...
    change: (values                 )               => {
      ...
      return {
        ...
        config: [...common, ...body, `${prefix} nat rules ${name} description "Generated by ArchToolKit"`],
        verify: ['show running nat-policy', 'show session all filter nat-rule ' + name, 'commit description "ArchToolKit: NAT rule"'],
        ...
        push: {
          ...
          after: [{ name: 'Commit the candidate configuration', module: 'paloaltonetworks.panos.panos_commit_firewall', args: { provider: PROVIDER, description: 'ArchToolKit: NAT rule' } }],
        },
        findings,
      };
    },
    ...
    change: (values                 )               => {
      ...
      return {
        ...
        config: [
          ...
          `set network interface ethernet ${iface} comment "${str(values, 'comment', 'ArchToolKit')}"`,
        ...
        verify: [`show interface ${iface}`, `show routing route virtual-router ${vr}`, 'commit description "ArchToolKit: interface and zone"'],
        ...
        push: {
          ...
          args: {
            ...
            comment: str(values, 'comment', 'ArchToolKit'),
            state: 'present',
          },
          after: [{ name: 'Commit the candidate configuration', module: 'paloaltonetworks.panos.panos_commit_firewall', args: { provider: PROVIDER, description: 'ArchToolKit: interface' } }],
        },
        findings,
      };
    },
