...
export const NETWORK_BLUEPRINTS                            = [IOS_NETWORK, NXOS_NETWORK, EOS_NETWORK, PANOS_NETWORK, FORTIOS_NETWORK, F5_NETWORK];

/** Every blueprint, with its structured change builder, by id. */
export const NETWORK_CHANGES                             = [...IOS_CHANGES, ...NXOS_CHANGES, ...EOS_CHANGES, ...PANOS_CHANGES, ...FORTIOS_CHANGES, ...F5_CHANGES];
