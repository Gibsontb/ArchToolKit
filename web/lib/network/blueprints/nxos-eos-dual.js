...
import { familyOf, isIpv4Address, parseCidrAny,             } from '../../core/ip.js';
...
export function dualCidrs(value        )                 {
...
export function dualAddresses(value        )               {
  return split(value, (item) => {
...
export function dualFindings(code        , label        , dual               , example        )            {
  return [
...
export function noIpv6(code        , feature        , platform        )          {
 ...
 */
export function unverifiedIpv6(code        , feature        , platform        )          {
...
export function routerIdFindings(code        , value        )            {
 ...
 */
export function ipv6Rule(rule        , icmp                   )         {
...
export function prefixEntry(line        )                       {
