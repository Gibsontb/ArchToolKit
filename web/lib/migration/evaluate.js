...
import { EMPTY_CATALOG, recommendServices,                     } from './services.js';
 ...
 */
export function normalizeCompliance(list                            )           {
...
export function isRegulated(compliance                   )          {
...
export function courseOfAction(app             , readiness        )                                      {
...
export function riskOf(app             )                                    {
  ...
  const risk       = points >= 8 ? 'High' : points >= 5 ? 'Medium' : 'Low';
  return { risk, because };
}
 ...
 */
export function evaluate(app             , catalog                 = EMPTY_CATALOG)             {
