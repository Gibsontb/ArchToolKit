...
export const CRITICALITY = ['Low', 'Medium', 'High', 'Mission Critical']         ;
...
export const CLOUDS = ['aws', 'azure', 'gcp', 'oci']         ;
...
export const SUGGESTED_OS_RUNTIMES                    = [
...
export const SUGGESTED_DATABASES                    = [
  "SQL Server",
...
export const SUGGESTED_HOSTING                    = [
  "VMware vSphere",
  "Hyper-V",
  "Bare Metal",
  "KVM",
...
export const SUGGESTED_VENDORS                    = [
  "Custom Built",
  "Open Source",
  "Microsoft",
  "Oracle",
...
export const SUGGESTED_IDENTITY                    = [
  "Active Directory (AD)",
  "LDAP",
  "Kerberos",
  "Azure AD / Entra ID",
