...
const AHB_SQL                         = ['azure-sqlmi', 'azure-sqlvm', 'azure-sqldb'];

const isWindows = (w          )          => osKind(w.os) === 'windows';
const hasSa = (ctx             )          => ctx.requirements.licensing.microsoftSa !== 'no';
const keptAsIs = (w          , ctx             )          => {
