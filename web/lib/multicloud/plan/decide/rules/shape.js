...
export const SHAPE_RULES                     = [
  ...
  rule          ({
    ...
    evaluate: (_w, o, ctx) => {
      const delta = ({ vmware: 2, aws: 2, azure: 2, google: 1, oci: 1 }         )[o.platform];
  ...
  rule          ({
    ...
    evaluate: (w, o, ctx) => {
      ...
      const fit = rightsize(o.platform                                      , w.vcpu, w.ramGib);
