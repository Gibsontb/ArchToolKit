...
import { HYPERSCALERS, isHyperscaler, platformInfo,               } from '../../../platforms.js';
import { vmwareCloudService } from '../../../vmware-on-cloud.js';
import { DB_SERVICES, serviceLicences, unsupportedOn } from '../../db-catalog.js';
import { imageFor, isUnavailable } from '../../images.js';
import { DB_FEATURE_OPTIONS, labelOf } from '../../options.js';
                                                                      
                                                  
import { rule,                                } from '../engine.js';

const short = (p          )         => platformInfo(p).shortLabel;
...
export const GOVERNMENT_REGION                                                        = {
  aws: /^us-gov-/i,
  azure: /^(usgov|usdod)/i,
  google: /gov/i,
...
export const ODB_SERVICES                         = ['aws-odb-exadata', 'aws-odb-adb', 'azure-odb-exadata', 'azure-odb-adb', 'google-odb-exadata', 'google-odb-adb', 'google-odb-basedb'];

function isProd(db          , ctx             )          {
...
export const ELIMINATION_RULES                     = [
  ...
  rule          ({
    ...
    evaluate: (_item, o, ctx) => {
      ...
      const re = GOVERNMENT_REGION[o.platform                               ];
