...
import { computeTargetFor, networkOf, spreadAcrossZones } from './compute.js';
                                                              
import { networkZones } from './network.js';
...
export function dcWorkloads(plan      , platform          , prefix        )             {
