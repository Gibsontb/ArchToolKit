 ...
 */
export const FLEET_FIRST_INSTANCE                                        = {
  simple: {
    vcpu: 76,
    ramGib: 251,
    diskGib: 7448,
 ...
 */
export const FLEET_ADDITIONAL_INSTANCE                                        = {
  simple: {
    vcpu: 34,
    ramGib: 111,
    diskGib: 4562,
 ...
 */
export const VCF_MANAGEMENT_SERVICES                                      = {
  simple: {
    vcpu: 40,
    ramGib: 82,
    diskGib: 3000,
 ...
 */
export function raidOverhead(topology                 , hostsPerSite        )               {
