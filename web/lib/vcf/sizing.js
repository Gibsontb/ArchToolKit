...
export function minimumHosts(input                                                    )   
...
export function computeCapacity(hostCount        , host          , reserveFailure         )                 {
...
export function computeLicensing(hostCount        , host          , isEdge = false)                  {
