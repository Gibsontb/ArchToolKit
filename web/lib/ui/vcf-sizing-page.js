...
import { sizeDeployment, recommendHostCount, minimumHosts,                                     } from '../vcf/sizing.js';
import {
...
const PROFILE_OPTIONS = (Object.keys(DEPLOYMENT_PROFILE_LABELS)                       ).map((value) => ({
  value,
...
export function mountVcfSizingPage(root             )       {
  ...
  function currentInput()              {
    ...
    return {
      ...
      storage: controls.storage.value               ,
