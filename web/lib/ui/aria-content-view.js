 ...
 */
export function viewCanvas(view                )              {
...
export function viewViewer(views                           , dashboards                      , reports                             )            {
...
function sectionRow(section               , index        , viewsById                                     , dashboardsById                                )              {
...
export function reportViewer(reports                             , views                           , dashboards                      )            {
...
export function mountViewsView(container             , views                           , dashboards                      , reports                             )            {
...
export function mountReportsView(container             , reports                             , views                           , dashboards                      )            {
