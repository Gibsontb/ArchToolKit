...
import { classifyType, nearestTypes } from './catalog.js';
...
export function resourcesIn(map          )                    {
  const seen = new Set        ();
...
function isCheckable(target             , name        )          {
...
export function nameStatus(target             , name        )             {
...
export function mapCoverage(map          )   
...
export function mapFindings(map          )                     {
