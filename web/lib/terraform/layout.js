...
export function tfvarsExample(variables                         )         {
  ...
  const describe = (v              ) => (v.description ? [`# ${v.description}`] : []);
...
export function tfvarsExampleFor(hcl        )         {
...
function readme(files                                  , required                         )         {
 ...
 */
export function asRootModule(result             )              {
