...
import { isOn } from './dual-stack.js';
...
const SPECS                                 = [
  {
    ...
    fields: [
      ...
      { input: 'network_name', default: 'app-vpc' },
  ...
  },
  {
    ...
    fields: [
      { input: 'project_id', default: 'my-gcp-project' },
      { input: 'name', label: 'Cluster name', default: 'app-gke' },
      { input: 'region', default: 'us-central1' },
      { input: 'regional', label: 'Regional cluster', default: 'true' },
      { input: 'network', default: 'app-vpc' },
      { input: 'subnetwork', default: 'app-subnet' },
      { input: 'ip_range_pods', default: 'app-pods', hint: 'Secondary range name for pods' },
      { input: 'ip_range_services', default: 'app-services' },
  ...
  },
  {
    ...
    name: 'project',
    fields: [
      { input: 'name', label: 'Project name', default: 'app-prod' },
  ...
  },
  {
    ...
    fields: [
      { input: 'project_id', default: 'my-gcp-project' },
      { input: 'names', label: 'Bucket names', default: 'app-archive,app-evidence' },
      { input: 'prefix', default: 'app', hint: 'Prepended to every name' },
      { input: 'location', default: 'US' },
      { input: 'storage_class', default: 'STANDARD' },
      { input: 'versioning', default: '', hint: 'key=value per bucket, e.g. app-archive=true' },
  ...
  },
  {
    ...
    fields: [
      { input: 'project_id', default: 'my-gcp-project' },
      { input: 'name', label: 'Instance name', default: 'app-pgsql-01' },
  ...
  },
  {
    ...
    fields: [
      { input: 'project_id', default: 'my-gcp-project' },
      { input: 'name', label: 'Instance name', default: 'app-mysql-01' },
  ...
  },
  {
    ...
    fields: [
      { input: 'project_id', default: 'my-gcp-project' },
      { input: 'names', default: 'app-automation,app' },
  ...
  },
  {
    ...
    fields: [
      { input: 'project_id', default: 'my-gcp-project' },
      { input: 'region', default: 'us-central1' },
      { input: 'name', default: 'app-nat' },
      { input: 'router', default: 'app-router', hint: 'An existing Cloud Router' },
  ...
  },
  {
    ...
    fields: [
      { input: 'project_id', default: 'my-gcp-project' },
      { input: 'name', label: 'Zone name', default: 'app-internal' },
      { input: 'domain', default: 'app.internal.', hint: 'Trailing dot required' },
  ...
  },
  {
    ...
    fields: [
      ...
      { input: 'keyring', default: 'app-keyring' },
      { input: 'keys', default: 'app-data-key', hint: 'Comma-separated key names' },
  ...
  },
  {
    ...
    fields: [
      ...
      { input: 'log_sink_name', default: 'app-audit-sink' },
  ...
  },
  {
    ...
    fields: [
      { input: 'project_id', default: 'my-gcp-project' },
      { input: 'dataset_id', default: 'app_analytics' },
      { input: 'dataset_name', default: 'App analytics' },
      { input: 'location', default: 'US' },
...
function networkFindings(values                 )            {
...
export const GOOGLE_TERRAFORM_MODULES                 = {
  target: 'google',
