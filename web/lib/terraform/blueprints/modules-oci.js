...
const SPECS                                 = [
  {
    ...
    fields: [
      ...
      { input: 'vcn_name', default: 'court-vcn' },
      { input: 'vcn_cidrs', label: 'VCN CIDRs', default: '10.50.0.0/16' },
      { input: 'vcn_dns_label', default: 'courtvcn', hint: 'Letters and digits only' },
      { input: 'label_prefix', default: 'court' },
  ...
  },
  {
    ...
    fields: [
      ...
      { input: 'tenancy_id', label: 'Tenancy OCID', default: '' },
      { input: 'region', default: 'us-ashburn-1' },
      { input: 'cluster_name', default: 'court-oke' },
  ...
  },
  {
    ...
    fields: [
      ...
      { input: 'instance_display_name', default: 'court-app-01' },
  ...
  },
  {
    ...
    fields: [
      { input: 'compartment_id', label: 'Compartment OCID', default: '' },
      { input: 'drg_display_name', default: 'court-drg' },
      { input: 'label_prefix', default: 'court' },
