...
import { dualStackInput, ipv4Range, ipv6Range, isOn, nthSlash64, sources } from './dual-stack.js';
...
const BLUEPRINTS                       = [
  {
    ...
    build: (values                 , name        ) => {
      ...
      const rule = (ruleName        , priority        , from          )         => `  security_rule {
    name                       = "${ruleName}"
    priority                   = ${priority}
    direction                  = "Inbound"
    access                     = "Allow"
