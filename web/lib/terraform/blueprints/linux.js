...
import { LINUX_SCENARIOS } from './linux-scenarios.js';

const PROVIDERS                        = ['cloudinit', 'tls', 'dns', 'ansible', 'local', 'random', 'null'];

/** BIND and most Linux DNS servers take TSIG-signed updates, not Kerberos. */
function tsigByDefault(blueprint           )            {
  return {
    ...blueprint,
