...
import { VCF_SCENARIOS } from './vmware-vcf-scenarios.js';
import { NSX_SCENARIOS } from './vmware-nsx.js';
import { AVI_SCENARIOS } from './vmware-avi.js';
import { VRA_SCENARIOS } from './vmware-vra.js';
import { VCD_SCENARIOS } from './vmware-vcd.js';

export const VCF_TERRAFORM                 = {
  target: 'vcf',
