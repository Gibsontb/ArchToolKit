...
function unquote(hcl        )         {
  return hcl.replace(QUOTED_REFERENCE, (_m, head        , ref        , tail        ) => `${head}${ref}${tail}`);
}

function declarations(hcl        )         {
...
export function liftSecrets(hcl        )         {
