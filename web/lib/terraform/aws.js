...
import { renderFile, str, num, bool, raw,                                  } from './hcl.js';
import {
...
function tagsAttribute(plan                , name        )               {
...
export function emitAwsFoundation(plan                )                   {
  const findings            = checkFoundationAddresses(plan, 'aws', 'An AWS VPC');
