...
export const GCP_FUNCTION_RUNTIMES                          = [
 ...
 */
export const AZURE_RUNTIME_STACKS                          = [
 ...
 * at apply time.
 */
export const DB_ENGINE_VERSIONS                          = [
...
export const S3_STORAGE_CLASSES                          = described({
...
export const EBS_VOLUME_TYPES                          = described({
...
export const AZURE_DISK_TYPES                          = described({
...
export const GCP_DISK_TYPES                          = described({
...
export const GCP_STORAGE_CLASSES                          = described({
  STANDARD: 'frequent access',
...
export const OCI_STORAGE_TIERS                          = described({
  Standard: 'frequent access',
 ...
 */
const WINDOWS_UPDATE_CATEGORIES                          = [
