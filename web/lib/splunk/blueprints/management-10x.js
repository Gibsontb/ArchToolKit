...
import { isIpv6, splitHostPort, urlHost } from '../../core/ip.js';
 ...
 */
function bashScript(name        , purpose                   , options                         , body                   , dryRunHelp = 'Preview. The script prints what it would do and changes nothing.')           {
...
const KV_TARGET                                   = { '9.4': '7.0', '10.0': '7.0', '10.2': '8.0', '10.4': '8.0' };

function kvstoreUpgrade()                  {
  return splunkBlueprint({
...
export const MANAGEMENT_10X_BLUEPRINTS                             = [distributedSearch(), kvstoreUpgrade(), healthReport()];
