...
import { COLLECTIONS, collectionFor, collectionOfModule } from './collections.js';
import { ANSIBLE_CATALOG_DATA, ANSIBLE_CATALOG_FETCHED_AT } from './catalog-data.js';
...
export function catalogueFor(collection        )                                 {
 ...
 */
export function classifyModule(module        )             {
