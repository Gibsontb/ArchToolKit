...
import { dualStackInput, ipv4Range, isOn, slash64, sources, withAnsibleUtils } from './ipv6.js';
...
const BLUEPRINTS                       = [
  ...
  },
  {
    ...
    build: (values                 , name        ) => {
      ...
      const subnetV6 = (n        ) => (v6 ? { ipv6_cidr: slash64(block, n), assign_instances_ipv6: true } : {});
      if (v6) {
        findings.push(
