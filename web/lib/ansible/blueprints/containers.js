...
const varSafe = (s        )         => s.toLowerCase().replace(/[^a-z0-9]+/g, '_').replace(/^_+|_+$/g, '');

const K8S_LOCAL = { hosts: 'localhost', connection: 'local', gather_facts: false }         ;
...
export const CONTAINERS_PLAYBOOKS                       = [
  docker_host_app,
  compose_project,
  podman_systemd,
  k8s_app,
