...
import { LOGS_MORE, NETWORKS_MORE } from './vcf-logs-networks-more.js';
...
import { PIPELINE_VCF } from './pipeline-vcf.js';
...
export const AUTOMATIONS                                 = [...OPERATIONS, ...NETWORKS, ...LOGS, ...AUTOMATION, ...VCF_FLEET, ...PIPELINES];
