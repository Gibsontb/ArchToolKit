...
import { API_REF, csvCell, envName, isIp, isIpv6, NET, NET_SRC, pipeRows, shq, SNMP_AUTH, SNMP_PRIV } from './vcf-networks-common.js';
...
const KIND_OPTIONS                 = Object.entries(DS_KINDS).map(([value, kind]) => ({ value, label: kind.label, group: kind.group }));
...
export const VCFNET_DATA_SOURCES                      = automationBlueprint({
