...
export const VCF_AUTOMATION_AUTOMATIONS                                 = [
  automationBlueprint({
    ...
    automation: (values                 , name        )             => {
      ...
      const template = { name: templateName, description: `Generated by ArchToolKit. ${sizes.join(', ')} sizes; ${lease > 0 ? `${lease}-day lease` : 'no lease'}.`, yaml };
        ...
        abx: [
          {
            ...
            description: `Generated by ArchToolKit. Runs on ${topic}; ${failOpen ? 'fails open' : 'fails closed'}.`,
