  ...
  automationBlueprint({
    ...
    automation: (values                 , name        )             => {
      ...
      const steps              = [
        ...
        ...(withNsx ? [{ method: 'POST'         , path: '/iaas/api/cloud-accounts-nsx-t', payload: `${base}-nsx.json`, captureAs: 'NSX_ACCOUNT_ID', secrets: { password: 'NSX_PASSWORD' }, tracked: true }] : []),
      ];
      ...
      return {
        ...
        files: {
          ...
          'apply.sh': applyScript(
            'vcf-automation',
            [
              ...(range ? [{ method: 'POST'         , path: '/iaas/api/network-ip-ranges', payload: `${base}-ip-range.json` }] : []),
