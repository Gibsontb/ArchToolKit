...
export function usageFileBase(script        )                     {
 ...
 */
export function forInterpreter(platform                    , text        )         {
