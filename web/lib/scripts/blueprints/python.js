      ...
      return {
        ...
        body: [
          ...preamble(
            ...
            [`Read a CSV, ${operation} it, and write a new one.`, '', 'The input is never modified.', '', ''],
          ),
          '',
      ...
      return {
        ...
        body: [
          ...preamble(
            ...
            [`Fetch ${str(values, 'endpoint', '')} from ${baseUrl}.`, '', 'Authentication comes from the environment. Retries are bounded and backed off.', '', ''],
          ),
          '',
          ...
          '    headers = {"Accept": "application/json", "User-Agent": "automation/1.0"}',
          ...(auth === 'bearer'
            ? [
      ...
      return {
        ...
        body: [
          ...preamble(
            ...
            [`Summarise ${format} logs.`, '', 'Reads a line at a time, so file size does not matter.', '', ''],
          ),
          '',
          ...(format === 'apache'
            ? [
      ...
      return {
        ...
        body: [
          ...preamble(
            ...
            [`Find ${find} files under a folder.`, '', 'Two passes by size then hash, symlinks not followed, a manifest before anything moves.', '', ''],
          ),
          '',
