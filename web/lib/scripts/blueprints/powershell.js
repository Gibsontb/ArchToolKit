 ...
 */
function preamble(params                   , opts                                                                              = { changes: true })           {
  return [
...
export const POWERSHELL_BASE                             = [
  ...
  scriptBlueprint({
    ...
    inputs: [
      { id: 'task_name', label: 'Task name', control: 'text', default: 'VCF-DailyReport' },
    ...
    script: (values                 )         => {
      const task = identifier(str(values, 'task_name', 'VCF-Task'), 'VCF-Task');
      ...
      return {
        ...
        body: [
          ...
          '            Principal   = $principal',
          '            Settings    = $settings',
          '            Description = "Runs $ScriptPath. Registered on $((Get-Date).ToString(\'yyyy-MM-dd\'))."',
          '            Force       = $true',
          '        }',
