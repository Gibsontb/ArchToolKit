...
import type { RehostCloud } from '../../kit/rightsize.ts';
import { rehostFiles, vsphereLandingFiles, REHOST_EMITS, LANDING_EMITS } from '../estate.ts';
import { AWS_REGIONS, AZURE_REGIONS, GCP_ZONES, OCI_REGIONS } from './regions.ts';
...
const SCOPE_INPUTS: readonly BlueprintInput[] = [
  {
    id: 'source_cluster',
...
const REGIONS: Record<RehostCloud, { label: string; options: readonly string[]; fallback: string }> = {
...
const SERVICE: Record<RehostCloud, string> = {
...
export function rehostBlueprint(cloud: RehostCloud): Blueprint {
...
export const VSPHERE_LANDING: Blueprint = {
