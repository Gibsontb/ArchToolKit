...
import { error, hasErrors, info, warning, type Finding } from '../core/findings.ts';
...
export function emitOciFoundation(plan: FoundationPlan): FoundationOutput {
