...
import { renderFile, str, num, strings, raw, type HclBlock } from './hcl.ts';
import {
  identifier,
  resourceName,
  type FoundationPlan,
...
export function emitVsphereFoundation(plan: FoundationPlan): FoundationOutput {
  ...
  return {
    files: {
      'main.tf': renderFile(
        blocks,
        `vSphere foundation for ${base}, generated by ArchToolKit.`,
      ),
