...
export interface AutomationPackageSpec {
  /** Fully qualified, lower case, dots: vcf.automation.tags.compliance. Also the module of its actions. */
  readonly packageName: string;
  readonly description: string;
  /** major.minor.patch; default 1.0.0. Orchestrator lists the package as <packageName>-<version>. */
  readonly version?: string;
  /** The folder of the workflow, the configuration element and the resources, e.g. Automation/Tags. */
