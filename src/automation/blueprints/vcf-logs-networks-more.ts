...
import { importGuide, networksApi, networksScheduledEnv } from './vcf-networks-logs.ts';
import { API_REF } from './vcf-networks-common.ts';
import { VCFNET_DATA_SOURCES } from './vcf-networks-sources.ts';
import { VCFNET_APPLICATIONS, VCFNET_APP_DISCOVERY } from './vcf-networks-apps.ts';
import { VCFNET_MICROSEG } from './vcf-networks-microseg.ts';
import { VCFNET_ACCESS, VCFNET_BACKUP, VCFNET_INTENTS, VCFNET_IP_DEFINITIONS, VCFNET_IP_TAGS_DNS, VCFNET_SEARCH_ALERT } from './vcf-networks-settings.ts';
...
const VCFNET_INTENT_CHECK: AutomationBlueprint = automationBlueprint({
