...
import { logsChartQuery, networksPreamble, networksScheduledEnv, type LogsConstraint } from './vcf-networks-logs.ts';
...
export const LOGS_MORE: readonly AutomationBlueprint[] = [
  ...
  automationBlueprint({
    ...
    automation: (values: BlueprintValues, name: string): Automation => {
      ...
      const errorConstraints: LogsConstraint[] = [
        ...(appFilter ? [{ internalName: 'appname', operator: 'CONTAINS' as const, value: appFilter }] : []),
        ...
        files: {
          ...
          'apply.sh': applyScript(
            ...
            [
              ...
              ...(archivePayload ? [{ method: 'PUT' as const, path: '/api/v2/archiving', payload: `${base}-archive.json` }] : []),
            ],
