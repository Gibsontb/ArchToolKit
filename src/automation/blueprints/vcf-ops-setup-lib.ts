 ...
 */
export const OBJECT_KINDS: readonly { value: string; label: string; group: string }[] = [
...
export function kindOf(value: string): { adapterKind: string; resourceKind: string } {
...
export function bareIpv6InUrl(url: string): boolean {
...
export function opsScript(opts: {
  ...
  readonly secrets?: readonly ScriptEnv[];
  readonly env?: readonly ScriptEnv[];
