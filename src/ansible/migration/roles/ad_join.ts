...
import { SSSD_CONF } from '../templates/sssd.ts';
...
export function assertVault(names: readonly string[], why: string): Task {
  return {
...
export const WINDOWS_AD_JOIN: Role = {
...
export const LINUX_AD_JOIN: Role = {
  name: 'linux_ad_join',
