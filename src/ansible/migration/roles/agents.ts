...
const LINUX_PACKAGES: Record<string, string[]> = {
...
const WINDOWS_PROGRAMS: Record<string, string[]> = {
...
export const CLOUD_AGENTS: Role = {
  name: 'cloud_agents',
...
export const VMWARE_TOOLS_REMOVAL: Role = {
