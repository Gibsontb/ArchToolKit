...
import { items, on, playbookScenario } from './scenario.ts';

/** `port` or `from-to` lines as [min, max]. */
function portRanges(value: unknown): [number, number][] {
...
export const PRIVATE_CLOUDS_PLAYBOOKS: readonly Blueprint[] = [
  playbookScenario({
