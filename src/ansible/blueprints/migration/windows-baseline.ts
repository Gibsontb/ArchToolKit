...
import { LOCKDOWN_WINDOWS, WINDOWS_BASELINE } from '../../migration/roles/index.ts';
import { WINRM_BOOTSTRAP_PS1 } from '../../migration/templates/winrm.ts';
import { HARDENING_INPUT, list, lockdownRequirement, migrationBlueprint, PLATFORM_INPUT, ports, text, TRUE_FALSE, yes } from './common.ts';
