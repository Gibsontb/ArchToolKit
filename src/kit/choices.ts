...
export function applyChoices(input: BlueprintInput, target: string): BlueprintInput {
...
export function withChoices(group: BlueprintGroup): BlueprintGroup {
...
export function withChoicesAll(groups: readonly BlueprintGroup[]): readonly BlueprintGroup[] {
