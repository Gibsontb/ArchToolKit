...
export const COMMERCIAL_RULES: readonly AnyRule[] = [
  ...
  rule<Workload>({
    ...
    evaluate: (_w, o) => {
      const delta = ({ azure: 2, aws: 2, vmware: 1 } as Partial<Record<Platform, number>>)[o.platform];
      return delta
