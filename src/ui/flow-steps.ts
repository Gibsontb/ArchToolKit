...
export type FlowStep = 'inventory' | 'sizing' | 'spec';

const STEPS: readonly { id: FlowStep; label: string; href: string; hint: string }[] = [
...
export function mountFlowSteps(root: HTMLElement, current: FlowStep): void {
