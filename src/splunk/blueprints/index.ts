...
export const SEARCH_HEAD_APPS: BlueprintGroup = { target: 'search_head', label: TIERS.search_head.label, blueprints: SEARCH_HEAD_BLUEPRINTS };
export const INDEXER_APPS: BlueprintGroup = { target: 'indexer', label: TIERS.indexer.label, blueprints: INDEXER_BLUEPRINTS };
export const FORWARDER_APPS: BlueprintGroup = { target: 'forwarder', label: TIERS.forwarder.label, blueprints: FORWARDER_BLUEPRINTS };

export const SPLUNK_BLUEPRINTS: readonly BlueprintGroup[] = [SEARCH_HEAD_APPS, INDEXER_APPS, FORWARDER_APPS];

/** Every Splunk blueprint, with its structured builder, in one list. */
export const SPLUNK_APPS: readonly SplunkBlueprint[] = [...SEARCH_HEAD_BLUEPRINTS, ...INDEXER_BLUEPRINTS, ...FORWARDER_BLUEPRINTS];
