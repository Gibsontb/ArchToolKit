 ...
 */
export function ruleCovers(rule: NotificationRule, alert: AlertDefinition): boolean {
...
export function unnotifiedAlerts(content: AriaContent): readonly AlertDefinition[] {
...
function addressesOf(rule: NotificationRule): string[] {
...
export function ariaFindings(content: AriaContent): Finding[] {
...
export function ariaSummary(content: AriaContent): readonly { readonly label: string; readonly value: number; readonly note?: string }[] {
