    ...
    change: (values: BlueprintValues): DeviceChange => {
      ...
      return {
        ...
        config: [
          ...
          '        set description "Generated by ArchToolKit"',
          '        set status up',
          '    next',
          'end',
        ],
    ...
    change: (values: BlueprintValues): DeviceChange => {
      ...
      return {
        ...
        push: {
          ...
          args: { vdom: VDOM, state: 'present', firewall_service_custom: { name: '{{ item.name }}', tcp_portrange: '{{ item.tcp | default(omit) }}', comment: 'Generated by ArchToolKit' } },
          after: [
            {
      ...
      return {
        ...
        push: {
          ...
          args: {
            vdom: VDOM,
            state: 'present',
            firewall_ippool: { name, type: kind, startip: str(values, 'start_ip', ''), endip: str(values, 'end_ip', ''), arp_reply: bool(values, 'arp_reply', true) ? 'enable' : 'disable', comments: 'Generated by ArchToolKit' },
          },
        },
      };
    },
