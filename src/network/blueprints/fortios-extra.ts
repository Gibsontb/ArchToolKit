 ...
 */
const PUSHES: Readonly<Record<string, (values: BlueprintValues, name: string) => NonNullable<ChangeBlueprint['change'] extends never ? never : ReturnType<ChangeBlueprint['change']>['push']>>> = {
...
export const FORTIOS_EXTRA: readonly ChangeBlueprint[] = BLUEPRINTS.map((blueprint) => {
