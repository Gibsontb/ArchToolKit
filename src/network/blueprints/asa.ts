...
import { description, listOf, netmask, parseCidr, type DeviceChange } from '../device.ts';
    ...
    change: (values: BlueprintValues): DeviceChange => {
      ...
      return {
        ...
        config: [
          ...
          `interface ${iface}`,
          ...(vlan > 0 ? [` vlan ${vlan}`] : []),
          ` description ${description(str(values, 'port_description', ''), 'ArchToolKit')}`,
          ` nameif ${name}`,
  ...
  deviceBlueprint({
    ...
    change: (values: BlueprintValues): DeviceChange => {
      ...
      return {
        ...
        config: [
          `access-list ${acl} remark ${description(str(values, 'remark', ''), 'Generated by ArchToolKit')}`,
        ...
        backout: [
          ...
          `no access-list ${acl} remark ${description(str(values, 'remark', ''), 'Generated by ArchToolKit')}`,
        ],
        findings,
      };
    },
    ...
    change: (values: BlueprintValues): DeviceChange => {
      ...
      return {
        ...
        config: [
          ...
          '!',
          `crypto ipsec ikev2 ipsec-proposal ATK-PROPOSAL`,
          ...
          `crypto map ${map} ${sequence} set ikev2 ipsec-proposal ATK-PROPOSAL`,
        ...
        backout: [
          ...
          `no access-list ${acl}`,
          `no crypto ipsec ikev2 ipsec-proposal ATK-PROPOSAL`,
