...
export const NXOS_NETWORK: BlueprintGroup = { target: PLATFORM, label: 'Cisco NX-OS', blueprints: BLUEPRINTS };
export const NXOS_CHANGES: readonly ChangeBlueprint[] = BLUEPRINTS;
